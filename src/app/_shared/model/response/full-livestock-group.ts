import { FullLivestock } from "./full-livestock";

export interface FullLivestockGroup {
  ...
  status: 'draft' | 'pending' | 'approved' | 'rejected' | 'verified'; // You can extend status if needed
  createdAt: Date;            // Creation timestamp
  updatedAt: Date;            // Last update timestamp
  statusAt: Date;             // Timestamp when status was last updated
  livestocks?: FullLivestock[];  // <-- add this
}
